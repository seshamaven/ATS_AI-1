#!/usr/bin/env python3
"""
Test script for the comprehensive profile ranking endpoint
"""
...
# Configuration
BASE_URL = "http://localhost:5003"  # Local test server

def test_comprehensive_ranking():
    """Test with the provided job requirements"""
    ...
    print("=" * 80)
    print("TESTING COMPREHENSIVE PROFILE RANKING ENDPOINT")
    print("=" * 80)
...
def test_with_sample_data():
    ...
    print("=" * 80)
    print(f"URL: {BASE_URL}/api/test-profile-ranking")
    print()
    
    try:
        response = requests.post(
            f"{BASE_URL}/api/test-profile-ranking",
            json=payload,
            headers={'Content-Type': 'application/json'},
            timeout=30
        )
...
if __name__ == "__main__":
    print("Starting tests for comprehensive profile ranking endpoint...")
    ...
    # Test with your provided job requirements
